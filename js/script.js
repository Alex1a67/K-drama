...
function initContactForm() {
  ...
  form.addEventListener('submit', function (e) {
    ...
    btn.innerHTML = '<i class="bi bi-check-circle-fill" style="margin-right:8px;"></i> Message Sent! ❤️';
    btn.style.background = 'linear-gradient(90deg,#2a7a3b,#1e5e2c)';
    setTimeout(() => { btn.innerHTML = orig; btn.style.background = ''; form.reset(); }, 3400);
  });
}
